...
export default function RestaurantCard({ restaurant, onPress, showFullDetails = false, onFavoritesChange }: RestaurantCardProps) {
  ...
  const handleMapPress = () => {
    ...
    const mapsUrl = `https://maps.google.com/?q=${encodeURIComponent(restaurant.name)}`;
  ...
  return (
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.7}>
      <Image source={{ uri: restaurant.imageUrl || 'https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg' }} style={styles.image} />
      ...
      <View style={styles.content}>
        ...
        <View style={styles.locationRow}>
          ...
          <Text style={styles.distance}>{restaurant.distance?.toFixed(1) || '0.0'} km away</Text>
        </View>
